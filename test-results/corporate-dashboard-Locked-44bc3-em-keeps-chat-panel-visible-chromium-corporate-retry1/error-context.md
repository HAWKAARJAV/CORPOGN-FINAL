...
- Name: corporate-dashboard.spec.ts >> Locked Dashboard >> clicking a locked nav item keeps chat panel visible
- Location: tests/corporate-dashboard.spec.ts:138:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'Dashboard' }) resolved to 2 elements:
    1) <button type="button" class="group relative flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm transition-all text-slate-400 hover:bg-slate-800/60 hover:text-white cursor-not-allowed opacity-50">…</button> aka getByRole('button', { name: 'Dashboard', exact: true })
    2) <button type="button" class="group relative flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm transition-all text-slate-400 hover:bg-slate-800/60 hover:text-white cursor-not-allowed opacity-50">…</button> aka getByRole('button', { name: 'ESG Dashboard' })
    ...
    - complementary [ref=e13]:
      ...
      - generic [ref=e16]:
        - generic [ref=e17]:
          - img [ref=e19]
          - generic [ref=e23]:
            - paragraph [ref=e24]: Test Corporation 1779790084361
    ...
    - generic [ref=e142]:
      - generic [ref=e143]:
        ...
        - generic [ref=e147]:
          ...
          - generic [ref=e152]:
            - img [ref=e154]
            - generic [ref=e158]: corp+1779790084361
      - generic [ref=e160]:
        - generic [ref=e161]:
          - generic [ref=e162]:
